...
@CucumberOptions(features = { "@rerun/failed_scenarios.txt" }, 
			...
			plugin = { "json:Json_Report/cucumber.json","com.cucumber.listener.ExtentCucumberFormatter:" } 
...
public class ReRunner {
	...
	public static void ReportNameSetup() {
		...
		ExtentProp.setReportPath(System.getProperty("user.dir")+"/output/"+LocalDate.now().toString()+random.nextInt()+"RerunReport.html");
	}
	@AfterClass
